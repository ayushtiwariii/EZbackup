...
INSERT INTO `admins` VALUES (1,'admin','admin123'),(2,'ayush','ayush@123');
...
INSERT INTO `books` VALUES (1,'computer network','robert frost',1),(2,'coding c++','ankit yadav ',1);
...
CREATE TABLE `issuedbooks` (
  ...
  CONSTRAINT `issuedbooks_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`)
...
INSERT INTO `students` VALUES (1,'aryan soni ','aryan.soni@gmail.com');
...
-- Dump completed on 2025-05-29 18:09:14
